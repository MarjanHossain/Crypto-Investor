        ...
        <section className="lg:px-20">
            ...
            <div className="lg:flex justify-around ">
                ...
                <div className="lg:block hidden ">
                    <img className="lg:w-[450px]" src={phone} alt="" />
                </div>
                ...
                <div className="flex lg:items-center  text-center lg:text-left lg:px-20">
                    <div className="space-y-3 ">
                        <div className="relative">
                            <h1 className="lg:text-5xl text-2xl  tracking-tight font-semibold leading-snug">Be Part of <br /> Something Massive</h1>

                            <div className="absolute lg:right-20 right-3"> <img src={header} className="w-1/2 lg:w-full" alt="" /></div>
                        </div>

                        <p className="lg:pt-12 lg:pb-6 lg:text-lg text-left text-primary   ">
